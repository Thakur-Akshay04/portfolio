...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    if (!contextResult || !contextResult.gl || !contextResult.ext || !contextResult.ext.formatRGBA) {
    ...
    function getWebGLContext(c: HTMLCanvasElement) {
      ...
      let webglContext: any = c.getContext("webgl2", params);
      ...
      let halfFloatTexType = isWebGL2
        ? webglContext.HALF_FLOAT
        : halfFloat && halfFloat.HALF_FLOAT_OES;
      let formatRGBA: any = null;
      let formatRG: any = null;
      let formatR: any = null;
      ...
      // Try 32-bit float if half-float is not renderable
      if (!formatRGBA) {
        if (isWebGL2) {
          halfFloatTexType = webglContext.FLOAT;
          formatRGBA = getSupportedFormat(webglContext, webglContext.RGBA32F, webglContext.RGBA, halfFloatTexType);
          formatRG = getSupportedFormat(webglContext, webglContext.RG32F, webglContext.RG, halfFloatTexType);
          formatR = getSupportedFormat(webglContext, webglContext.R32F, webglContext.RED, halfFloatTexType);
        } else {
          const floatExt = webglContext.getExtension("OES_texture_float");
          if (floatExt) {
            halfFloatTexType = webglContext.FLOAT;
            formatRGBA = getSupportedFormat(webglContext, webglContext.RGBA, webglContext.RGBA, halfFloatTexType);
            formatRG = getSupportedFormat(webglContext, webglContext.RGBA, webglContext.RGBA, halfFloatTexType);
    ...
    function getSupportedFormat(webgl: any, internalFormat: any, format: any, type: any): any {
