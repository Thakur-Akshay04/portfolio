        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-white/[0.08]">
            <div className="space-y-1">
              <div className="flex items-center gap-1.5 font-mono text-xs text-accent-purple font-semibold">
                <span>01</span>
                <span className="text-white font-display font-bold uppercase tracking-wider text-xs">
                  Systems
                </span>
              </div>
              <p className="text-xs text-neutral-400 leading-relaxed">
                Sub-150ms APIs, Redis caching, microservices, and zero-downtime DB migrations.
              </p>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-neutral-400 leading-relaxed">
                React 19, Next.js 16, TypeScript, fluid responsive layouts, and 60fps motion.
              </p>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-neutral-400 leading-relaxed">
                pgvector semantic search, LLaMA-3 workflows, FastAPI, and WebSocket pipelines.
              </p>
            </div>
          </div>

          {/* Meta Information & Direct Action */}
          <div className="flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-white/[0.08]">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white/[0.04] hover:bg-white/[0.08] border border-white/10 hover:border-white/20 text-xs font-medium text-white transition-all duration-200 group cursor-pointer"
            >
